...
public class NYTimes_RssBackgroundService : BackgroundService
{
    private static string _SourceName = "NYTimes";
    private readonly ILogger<NYTimes_RssBackgroundService> _logger;
    ...
    {
        ("https://rss.nytimes.com/services/xml/rss/nyt/MostEmailed.xml", _SourceName),
        ("https://rss.nytimes.com/services/xml/rss/nyt/MostShared.xml", _SourceName),
        ("https://rss.nytimes.com/services/xml/rss/nyt/MostViewed.xml", _SourceName)

    };

    public NYTimes_RssBackgroundService(
        ILogger<NYTimes_RssBackgroundService> logger,
        IMongoDatabase database,
        TelegramBotService telegramBotService)
    {
        _logger = logger;
        _newsCollection = database.GetCollection<NewsItem>($"News_{_SourceName}");
